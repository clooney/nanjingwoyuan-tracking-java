public class Test {
	...
	public static void main(String[] args) {
		try {
			...
			// String	urlStr ="/nanjingwoyuan/RP325552475CN/en";
			// String requestData=null;
			...
			// String	urlStr ="/nanjingwoyuan/RP325552475CN";
			...
			// String	urlStr =null;
			// String requestData="{\"tracking_number\": \"RP325552475CN\",\"carrier_code\":\"nanjingwoyuan\",\"destination_code\":\"US\",\"tracking_ship_date\": \"20180908\",\"tracking_postal_code\":\"12201\",\"specialNumberDestination\":\"UK\",\"order\":\"#123\",\"order_create_time\":\"2018/09/08 16:51\",\"lang\":\"en\"}";
			// String result = new Tracker().orderOnlineByJson(requestData,urlStr,"realtime");
			// System.out.println("result======="+result);

			// 10 Modify courier code
			// String	urlStr =null;
			// String requestData="{\"tracking_number\": \"RP325552475CN\",\"carrier_code\":\"nanjingwoyuan\",\"update_carrier_code\":\"china-ems\"}";
			...
			// String	urlStr =null;
			// String requestData= "[{\"tracking_number\":\"RP325552475CN\",\"carrier_code\":\"nanjingwoyuan\"},{\"tracking_number\":\"LZ448865302CN\",\"carrier_code\":\"china-ems\"}]";
			...
			// String	urlStr =null;
			// String requestData= "[{\"carrier_code\":\"nanjingwoyuan\",\"destination\":\"US\",\"original\":\"CN\"},{\"carrier_code\":\"china-ems\",\"destination\":\"US\",\"original\":\"CN\"}]";
